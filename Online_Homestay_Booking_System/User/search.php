...
?>
     ...
     <section class="section-background">
		...
		<button type="submit" name="searchbtn" class="btn btn-primary">Search</button>
			 ...
			 <?php
    $query = "SELECT * FROM home_details";
    $result = mysqli_query($connect, $query);
		...
		if(isset($_GET["searchbtn"]))
		{
			...
			$result = mysqli_query($connect, "SELECT * from home_details WHERE home_name LIKE '%$hname%' ");	
			
			if(mysqli_num_rows($result)==0)
			{
				echo "<br> Homestay Not Found.Please Try Again";
			}
			...
			<div class="courses-thumb courses-thumb-secondary">
                              ...
                              <div class="courses-info">
                                   <class="section-btn btn btn-primary btn-block"></a>
                              </div>
                         </div>
