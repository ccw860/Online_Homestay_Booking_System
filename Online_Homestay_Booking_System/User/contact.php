                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="" method="post">
                              ...
                              <div class="col-md-4 col-sm-12">
                                   <input type="submit" class="form-control" name="sendbtn" value="Send Message">
                              </div>
<?php
if (isset($_POST["sendbtn"]))
	{
		...
		$result = mysqli_query($connect,"SELECT * FROM contact_us where contact_id = '$cid'" );
		$count=mysqli_num_rows($result);
		mysqli_query($connect,"INSERT INTO contact_us(cus_name,email,message)VALUES('$name','$email','$message')");
	?>
	<script>
